...
users.users.greghab.packages =  
	with pkgs;[trilium vnote peek gitAndTools.git-extras
             ...
             okular
	           ...
	           i3-gaps dmenu rofi i3status i3lock i3blocks-gaps
             #nur.repos.sikmir.anki-bin
             ...
             hlint shellcheck nixfmt editorconfig-checker editorconfig-core-c
...
(python3.withPackages(ps: [
  ...
  ps.pyls-mypy ps.pyls-isort ps.pyls-black ps.pylint ps.pygobject3
]))
